        ...
        <!--Search Bar -->
            <form action="{{route('search')}}" method="GET">
                ...
                <div class="flex text-gray-600 items-center">
                    <input type="search" name="search" placeholder="Search" value="{{request()->search}}" class=" h-10 px-5 pl-5 rounded-full pr-10 bg-white text-sm focus:outline-none">
                ...
                <div class="flex gap-2 mt-3 ml-1">
