        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex py-5 lg:grid grid-cols-3 md:gap-5">
                ...
                <div class=" lg:col-span-2 w-full ">
                    ...
                    <!-- Add Post  =========================== -->
                    @if(Auth::user() === $user)
                    <div class="grid max-w-xl bg-white h-auto w-auto rounded-sm p-3 pb-1 pt-1 mb-4">
                        <div>
                            <!--Body-->
                            <div class="px-6 pb-3">
                                <!-- Title -->
                                ...
                                <div class="col-span-6 sm:col-span-4 mb-1">
                                    ...
                                    <textarea id="content" name="content" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 p-1  w-full border border-gray-300 rounded-md">{{ old('description') ?? $user->profile->description }} </textarea>
                                </div>
                                <!-- Url -->
                            ...
                            <div class="max-w-3xl flex  mb-3 justify-between">
                                <div class="flex items-stretch">
                                    <div class="mr-3 self-center">
                                        <img class="shadow h-10 w-10 rounded-full mx-auto" src="{{ $user->profile_photo_url }}" alt="{{ $user->name }}" />
                                    </div>
